...
<div class="controlPanel">
  ...
  <input class="controlPanelButton" type="button" value="Add new" onclick="location.href='/admin-expenses-new.php'"> <br/>
  ...
  <input class="controlPanelButton" type="button" value="Active" onclick="location.href='/admin-expenses.php'"> <br/>
  <script>
    $(function () {
...
<div class="dataField">
  <h2 class="tableHeader">Deleted Expenses</h2>
  <form action="/admin-expenses-deleted.php" method="post">
    <p class="dateFilter">
