...
<div class="controlPanel">
    ...
    <input class="controlPanelButton" type="button" value="Deleted" onclick="location.href='/admin-sales-deleted.php'">
    <br/>
</div>
<div class="dataField">

    <h2 class="tableHeader"> Sales</h2>

    <form action="/admin-sales.php" method="post">
        <p class="dateFilter">
